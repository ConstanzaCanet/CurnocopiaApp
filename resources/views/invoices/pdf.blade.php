...
<div class="header">
    ...
    <p>Fecha de emisión: {{ $order->updated_at->format('d/m/Y') }}</p>
</div>
...
<div class="details">
    ...
    <table>
        ...
        <tr>
            ...
            <td>{{ $user->billing_address }}</td> <!-- Asegúrate de tener este campo en tu modelo User -->
        </tr>
    </table>
</div>
...
<div class="details">
    ...
    <table>
        ...
        <tr>
            <th>Fecha de vencimiento del CAE:</th>
            <td>{{ $order->cae_vto }}</td>
        </tr>
    </table>
</div>
	...
	<table class="bill-container">
		<tr>
			<td class="padding-b-3">
				<p>Razón social: Cornucopia S.A.</p>
				<p>Direccion: Calle falsa 123</p>
				<p>C.U.I.T.: 12345678912</p>
				<p>RESPONSABLE INSCRIPTO</p>
				<p>IIBB: 12345432</p>
				<p>Inicio de actividad: 2/9/2024</p>
			</td>
		</tr>
		<tr>
        ...
        <p><strong>Dirección de Facturación:</strong> {{ $order->shipping_address }}</p>
		<tr>
			<td class="border-top padding-t-3 padding-b-3">
				<div>
					<table>
